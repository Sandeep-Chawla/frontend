...
function Card() {
  return (
        <div className="bg-[#fff] rounded-3xl shadow-xl p-6 text-center">
            ...
            <p className="text-primary font-semibold text-sm mb-4 text-justify xl:px-10 mt-6 leading-6">Lorem ipsum is simply dummy text of the printing and
                typesetting industry. Lorem ipsum has been the industry's standard dummy text ever since.</p>
            <button className="bg-primary text-white w-3/4 mx-auto font-bold text-sm md:text-sm xl:text-md rounded-3xl xl:mt-6 py-3">LEARN MORE</button>
        </div>
